...
def getData():
    ...
    df_august = pd.read_csv('/home/miko/anaconda3/envs/PMLDS/PMLDS/data/apartments_pl_2023_08.csv')
    #df_september = pd.read_csv('/kaggle/input/apartment-prices-in-poland/apartments_pl_2023_09.csv')
    df_september = pd.read_csv('/home/miko/anaconda3/envs/PMLDS/PMLDS/data/apartments_pl_2023_09.csv')
    #df_october = pd.read_csv('/kaggle/input/apartment-prices-in-poland/apartments_pl_2023_10.csv')
    df_october = pd.read_csv('/home/miko/anaconda3/envs/PMLDS/PMLDS/data/apartments_pl_2023_10.csv')
